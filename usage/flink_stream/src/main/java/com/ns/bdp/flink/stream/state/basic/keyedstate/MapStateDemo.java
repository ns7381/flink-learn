...
import com.ns.bdp.flink.source.RainfallSource;
...
/**
 * 此例持续划分降雨情况，将数据进行分组累积，获得代表已有数据的概要统计模型
 */
public class MapStateDemo {
    public static void main(String[] args) throws Exception {
        ...
        dataStream.keyBy((KeySelector<Tuple3<String, String, Integer>, String>) value -> {
            // 按同一年份来分区
